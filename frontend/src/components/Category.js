...
const dropDown = (ele) => {
    var elements = document.getElementsByClassName('category-dropDown-content')
    ...
    return (
           ...
           <div className='name-tag'><i className="fas fa-angle-double-left"/> CATEGORIES <i className="fas fa-angle-double-right"/></div>
            <div className='row category'>
                ...
                <div className='card category-btn'>
                ...
                {CategoryNames.map((category)=>(
                    <div key={category.name}  className='category  column-lg-6' >
                        ...
                        <div id={category.name} className='category-dropDown-content'>
